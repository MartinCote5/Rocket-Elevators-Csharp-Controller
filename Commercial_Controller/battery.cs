...
namespace Commercial_Controller
{
    ...
    public class Battery 
    {
        ...
        public Column findBestColumn(int requestedFloor) 
        {
                ...
                decimal findingColumnWithFloor = (decimal)requestedFloor / columnsList[1].servedFloors.Count;
                int columnIndex = Decimal.ToInt32(Math.Ceiling(findingColumnWithFloor));
